#ifndef ThetaStar_APPLICATION_H
#define ThetaStar_APPLICATION_H
//-----------------------------------------------------------------
...
// Application
//-----------------------------------------------------------------
class App_PathfindingThetaStar final : public IApp
{
public:
	//Constructor & Destructor
	App_PathfindingThetaStar() = default;
	virtual ~App_PathfindingThetaStar();
...
private:
	...
	App_PathfindingThetaStar(const App_PathfindingThetaStar&) = delete;
	App_PathfindingThetaStar& operator=(const App_PathfindingThetaStar&) = delete;
};
#endif
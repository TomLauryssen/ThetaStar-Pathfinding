...
//Includes
#include "App_PathfindingThetaStar.h"
#include "framework\EliteAI\EliteGraphs\EliteGraphAlgorithms\EBFS.h"
#include "framework\EliteAI\EliteGraphs\EliteGraphAlgorithms\ThetaStar.h"
using namespace Elite;

//Destructor
App_PathfindingThetaStar::~App_PathfindingThetaStar()
{
	SAFE_DELETE(m_pGridGraph);
}

//Functions
void App_PathfindingThetaStar::Start()
{
	//Set Camera
...
void App_PathfindingThetaStar::Update(float deltaTime)
{
...
void App_PathfindingThetaStar::Render(float deltaTime) const
{
	UNREFERENCED_PARAMETER(deltaTime);
	//Render grid
...
void App_PathfindingThetaStar::MakeGridGraph()
{
...
void App_PathfindingThetaStar::UpdateImGui()
{
